...
elseif(USE_OPENMP STREQUAL "llvm")
  find_package(OpenMP)
  if(OPENMP_FOUND)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${OpenMP_CXX_FLAGS}")
    find_library(OMP_LIBRARY NAMES libomp.so)
    if(NOT OMP_LIBRARY OR NOT OMP_LIBRARY MATCHES "libomp")
      message(FATAL_ERROR "LLVM mode requires libomp. Currently found: ${OMP_LIBRARY}")
    endif()
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${OMP_LIBRARY})
    add_definitions(-DTVM_THREADPOOL_USE_OPENMP=1)
    message(STATUS "Build with OpenMP " ${OMP_LIBRARY})
